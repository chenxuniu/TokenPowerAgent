...
completed run consumed.  \system{} retains L1 measurement as calibration
source and final authority, while L0/L2 records estimate which runs to purchase
next.  Its phase boundary preserves the semantics needed to compare them.
