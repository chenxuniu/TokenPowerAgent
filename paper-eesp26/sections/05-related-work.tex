...
decomposition supplies a prior, six measured workloads learn only a sparse
residual, and two no-refit holdouts audit its release boundary.  An exact
configuration contract bounds reuse.  It neither creates virtual GPUs nor claims that one
...
given an evaluator.  This work audits the evaluator itself.  It therefore
