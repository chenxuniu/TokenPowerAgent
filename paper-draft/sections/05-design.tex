...
search.  The Scenario Compiler turns natural language or YAML into a typed
specification and rejects infeasible candidates.  A language-model planner
...
$P_x=\mathbf 1[x\in\mathcal X_S^*]$.  The intent-specific terminal decision is
\begin{equation}
