...
\hypersetup{
  pdftitle={TokenPowerAgent: Evidence-Gated Multi-Fidelity Search for Energy-Efficient LLM Inference on Single-GPU HPC Nodes},
  pdfauthor={Anonymous Authors},
  pdfsubject={SC26 AgenticAI4HPC workshop paper},
  pdfkeywords={agentic AI, LLM inference, energy efficiency, multi-fidelity evidence, single-GPU HPC nodes}
}

\title{\LARGE \system{}: Evidence-Gated Multi-Fidelity Search\\
for Energy-Efficient LLM Inference on Single-GPU HPC Nodes}
