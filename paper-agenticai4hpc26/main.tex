...
\hypersetup{
  pdftitle={TokenPowerAgent: Evidence-Gated Multi-Fidelity Tuning for LLM Serving on Single-GPU HPC Nodes},
...
\title{\LARGE \system{}: Evidence-Gated Multi-Fidelity Tuning\\
for LLM Serving on Single-GPU HPC Nodes}
